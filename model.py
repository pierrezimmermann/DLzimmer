...
class CNN(Sequential):
    def __init__(self, name='cnn', dropout_rate=0.5, **kwargs):
        ...
        self.batch_normalization_layer_1 = BatchNormalization()
        ...
        self.batch_normalization_layer_2 = BatchNormalization()
